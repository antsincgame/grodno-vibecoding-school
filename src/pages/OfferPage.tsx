      ...
      <main className="section" style={{ paddingTop: '120px' }}>
        ...
        <div className="cyber-card" style={{ maxWidth: '800px', margin: '0 auto', lineHeight: 1.8, fontSize: '16px' }}>
          ...
          <p style={PARAGRAPH_STYLE}>
            ...
            программированию с использованием инструментов искусственного интеллекта в рамках AI-лаборатории
          ...
          <p style={{ marginBottom: '12px', opacity: 0.85 }}>
            <strong style={{ color: 'var(--neon-green)' }}>Базовый курс:</strong> 5 очных групповых занятий по 2 часа
            (группа до 6 человек). Стоимость — 1 000 BYN. Включает предоставление подписки Cursor Pro
          ...
          <p style={PARAGRAPH_STYLE}>
            ...
            с безлимитным доступом в AI-лабораторию 24/7. Стоимость — 3 000 BYN. Включает Cursor Ultra,
          ...
          <ul style={LIST_STYLE}>
            <li>Наличными в AI-лаборатории</li>
          ...
          <ul style={LIST_STYLE}>
            ...
            <li>Соблюдать правила поведения в AI-лаборатории</li>
